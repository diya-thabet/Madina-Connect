...
# FIX: Forwarding directly to Deployment on port 8000 (where uvicorn runs)
# Mapping container 8000 -> local 8001
kubectl port-forward deploy/planner-deployment 8001:8000 &
PID3=$!
